...
const oldDash = fs.readFileSync('old_dashboard.js', 'utf8');

const newDash = `window.AnalyticsDashboard = {
    render: function() {
        ...
        setTimeout(() => {
            ...
            if(window.employees) {
                window.employees.forEach(e => {
                    ...
                    if(st.toLowerCase().includes('site')) onSite++;
...
console.log('Successfully applied magical design!');
